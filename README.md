...
Use [CITATION.cff](CITATION.cff), with maintainer-confirmed creator Mohammad Jaradat, when citing the released software. Version 0.1.0 is the intended release; its date is not finalized. **DOI: Pending archival publication.** [Archival instructions](docs/archival_readiness.md), [draft release notes](docs/release_notes_v0.1.0.md), [changelog](CHANGELOG.md) and [release checklist](docs/release_checklist.md) prepare manual publication.
